<div id="modal" class="row">
    <div class="col col-md-12">
        <form id="formEditarTreinamentos" method="post" class="modal-editar m-0" onsubmit="return false;"  enctype="multipart/form-data">
            <input type="hidden" id="idTreinamentos" name="idTreinamentos">
            ...
            <div class="card mb-0">
                ...
                <div class="card-footer text-right px-3">
                    ...
                    <button type="submit" onclick="generic.Treinamentos.editar()" class="btn btn-outline-info">Editar</button>
                </div>
            </div>
        </form>
    </div>
