<div id="modal" class="row">
    <div class="col col-md-12">
        <form id="formEditarNivelPermissoes" method="post" class="modal-editar m-0" onsubmit="return false;"  enctype="multipart/form-data">
            ...
            <div class="card mb-0">
                ...
                <div class="card-footer text-right px-3">
                    ...
                    <button type="submit" onclick="generic.ConfigurarPermissoes.editar()" class="btn btn-outline-info">Editar</button>
                </div>
            </div>
        </form>
    </div>
