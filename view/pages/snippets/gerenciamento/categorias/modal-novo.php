<div id="modal" class="row">
    <div class="col col-md-12">
        <form id="formNovoCategorias" method="post" class="modal-novo m-0" onsubmit="return false;"  enctype="multipart/form-data">
            <div class="card mb-0">
                ...
                <div class="card-footer text-right px-3">
                    ...
                    <button type="submit" onclick="generic.Categorias.salvar()" class="btn btn-outline-success">Salvar</button>
                </div>
            </div>
        </form>
    </div>
