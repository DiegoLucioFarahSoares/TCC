<div id="modal" class="row">
    <div class="col col-md-12">
        <form id="formEditarCursos" method="post" class="modal-editar m-0" onsubmit="return false;"  enctype="multipart/form-data">
            <input type="hidden" id="idCursos" name="idCursos">
            ...
            <div class="card mb-0">
                    ...
                    <div class="row">
                        <div class="col col-12 col-sm-6 col-md-4 col-xl-4">
                            <div class="form-group mb-3">
                                <label for="iCategoria">Categoria <span class="text-danger">*</span></label>
                                <select id="iCategoria" name="iCategoria"
                ...
                <div class="card-footer text-right px-3">
                    ...
                    <button type="submit" onclick="generic.Cursos.editar()" class="btn btn-outline-info">Editar</button>
                </div>
            </div>
        </form>
    </div>
