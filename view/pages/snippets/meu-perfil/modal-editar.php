<div id="modal" class="row">
    <div class="col col-md-12">
        <form id="formEditarMeuPerfil" method="post" class="modal-editar m-0" onsubmit="return false;"  enctype="multipart/form-data">
            <input type="hidden" id="idPessoa" name="idPessoa">
            <input type="hidden" id="iNivelAcesso" name="iNivelAcesso">
            <input type="hidden" id="iDataNascimento" name="iDataNascimento">
                    ...
                    <div class="row">
                        ...
                        <div class="col col-12 col-sm-6 col-md-4 col-xl-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="iDataNascimento" name="iDataNascimento" readonly disabled
