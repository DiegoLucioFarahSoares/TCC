...
<?php include __DIR__ . "/../snippets/gerenciamento/treinamentos/main.php"; ?>
...
<script src="<?php print $sicPath; ?>/snippets/gerenciamento/treinamentos/assets/js/treinamentos.js?v=<?= time() ?>"></script>

<script type="text/javascript">
    var generic = new GenericService();
    generic.Treinamentos = new Treinamentos();
    generic.Treinamentos.init();
</script>
</body>
