...
<?php include __DIR__ . "/../snippets/gerenciamento/pessoa/main.php"; ?>
...
<script src="<?php print $sicPath; ?>/snippets/gerenciamento/pessoa/assets/js/pessoa.js?v=<?= time() ?>"></script>
<script src="<?php print $sicPath; ?>/assets/js/eEstados.js"></script>

<script type="text/javascript">
    var generic = new GenericService();
    generic.Pessoa = new Pessoa();
    generic.Pessoa.init();
</script>
</body>
