...
<?php include __DIR__ . "/../snippets/gerenciamento/midias/main.php"; ?>
...
<script src="<?php print $sicPath; ?>/snippets/gerenciamento/midias/assets/js/midias.js?v=<?= time() ?>"></script>

<script type="text/javascript">
    var generic = new GenericService();
    generic.Midias = new Midias();
    generic.Midias.init();
</script>
</body>
