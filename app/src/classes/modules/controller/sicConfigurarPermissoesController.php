...
use app\src\classes\modules\repository\sicConfigurarPermissoesRepository;
...
class sicConfigurarPermissoesController
{
    ...
    public function viewConfigurarPermissoes(Request $request, Response $response, array $args)
    {
        ...
        $dadosTela = [
            'title' => 'SIC - Sistema Interno Corporativo - Visualizar Permissões',
            'adminSIC' => sicService::adminSIC(),
        ];

        return $this->phpview->render($response, '/pages/gerenciamento/configurar-permissoes.php', $dadosTela);
    }
    ...
    public function consultar(Request $request, Response $response)
    {
        ...
        try {
            ...
            $repository = new sicConfigurarPermissoesRepository($conn);
